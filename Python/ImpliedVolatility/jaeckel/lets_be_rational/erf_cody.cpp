...
namespace {
  ...
  const double ONE_OVER_SQRT_PI = 0.56418958354775628695; // 1/sqrtpi
...
//     2(erfcx):             ]         <----(ii)---->        [           (iii)            [   (iv)
//
//       (i):   exp(-x_sqr)*[1/sqrtpi-P(z)/Q(z)]/|x| 
//      (ii):       [1/sqrtpi-P(z)/Q(z)]/|x|
//     (iii):           [1/sqrtpi]/|x|
//      (iv):               0
// with
//      z    := 1/x_sqr
