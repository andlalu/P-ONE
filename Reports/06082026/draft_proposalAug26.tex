...
\date{\item First version: June 16, 2018 \item Previous Version: July 21, 2026 \item This version: August 6, 2026}
%start file content
\begin{document}
\maketitle
%\abstract{
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.90\textwidth]{generated/noise_mechanics_diagnostics.pdf}
    \caption{Noise size and price-rounding effects across the 100 samples. The left panel reports the 95\% quantile of the absolute raw implied-volatility error before price rounding, in implied-volatility basis points. The right panel reports the percentage of prices adjusted to the lower price bound after rounding. The results are pooled across Designs A--C, which have matched marginal observation-error scales. Each maturity and moneyness point contains 157,800 observations.}
    \label{fig:app_noise_mechanics}
\end{figure}
