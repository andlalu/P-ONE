...
cf_coeff_save= price_fft_fut(0,0,std_T_graph,0,'SVHJ',theta_SVJ,0,1);

%coeff without jump size risk 
theta2=theta_SVHJ;
theta2(2)=theta_SVHJ(1);
...
%% Static analysis
vols = price_fft_fut([log(100);vbar0;],std_K_graph.*100 , std_T_graph, 0, 'SVJ', theta, 1, 0,cf_coeff_save);
vols2 = price_fft_fut([log(100);vbar0;],std_K_graph.*100 , std_T_graph, 0, 'SVJ', theta2, 1, 0,cf_coeff_save2);

prices = price_fft_fut([log(100);vbar0;],std_K_graph.*100 , std_T_graph, 0, 'SVJ', theta, 0, 0,cf_coeff_save);
prices2 = price_fft_fut([log(100);vbar0;],std_K_graph.*100 , std_T_graph, 0, 'SVJ', theta2, 0, 0,cf_coeff_save2);
