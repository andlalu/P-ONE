...
states_imp2=impl_state_func_fut(deriv_data, TT_marks, type, theta_SVHJ3);
...
func2 = @(theta) critstep1(freetobound(type,theta,lb,ub),states_imp2,dt,type);%,H0,OptMatrix);
