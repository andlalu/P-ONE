...
%% Static analysis
vols = price_fft_fut([log(100);vbar0;lambda0],std_K_graph.*100 , std_T_graph, 0, 'SVHJ', theta, 1, 0,cf_coeff_save);
vols2 = price_fft_fut([log(100);vbar0;lambda0],std_K_graph.*100 , std_T_graph, 0, 'SVHJ', theta2, 1, 0,cf_coeff_save2);
