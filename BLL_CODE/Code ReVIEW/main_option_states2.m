...
[deriv_data, states, TT_marks, coeff_mat ] = sim_deriv_data([log(100),0.2^2,5],N,dt,type,theta_SV,407057);%640449
...
theta_SV2=theta_SV;%[4,2.5,.015,.3,-0.45];
% theta_SV2(4)=theta_SV(4).*0.8;
[states_imp2,x_imp2]=impl_state_func_fut(deriv_data, TT_marks, type, theta_SV2);
